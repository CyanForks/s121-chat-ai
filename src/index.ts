...
import { AIConfig, ChatAIProvider } from "./chat-ai-provider";
...
export const Config: Schema<Config> = Schema.object({
  ...
  balanceToken: Schema.string().role("secret").description("查询余额的 token"),
  ...
  systemPrompt: Schema.array(Schema.object({
    role: Schema.union([
      Schema.const("system")
    ...
    content: Schema.string().role("textarea").required().description("内容"),
